...
Version  : 2.0.0
Release  : 79
URL      : https://github.com/tensorflow/estimator/archive/v2.0.0.tar.gz
Source0  : https://github.com/tensorflow/estimator/archive/v2.0.0.tar.gz
...
pip3 install --no-deps --force-reinstall --root %{buildroot}  /tmp/estimator_pip/tensorflow_estimator-2.0.0-py2.py3-none-any.whl
